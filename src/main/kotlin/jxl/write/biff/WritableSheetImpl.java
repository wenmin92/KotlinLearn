...
class WritableSheetImpl implements WritableSheet
{
   ...
   * @param ww the fonts used by the workbook
   ...
   *
   * @param cv the cell with data validation
   */
   ...
   * @param extraCols the number of cells downwards to apply this data validation
   */
